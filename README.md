...
UUID Creator is a library that generates [RFC-4122](https://tools.ietf.org/html/rfc4122) UUIDs and non-standard UUIDs/GUIDs.
...
This implementation is derived from the ULID specification. The only difference is that the millisecond bits are moved to the end of the GUID. Both COMB Guid and Lexical Order Guid use the same basic algorithm. See the section of Lexical Order GUIDs.
